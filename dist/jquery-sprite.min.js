...
l(a.elmt).is("cycle",a.cycle.toString())&&(this.to(1,!0),a.isEnd=!0,f.addClass("is-end-cicle")));if(a.config.hasOwnProperty("onFrame"))a.config.onFrame(this)});if(a.config.hasOwnProperty("onPlay"))a.config.onPlay(this);if(a.config.hasOwnProperty("onPause"))a.config.onPause(this)},reset:function(){f.removeClass("is-end-cicle");a.isEnd&&(l(a.elmt).set("cycle",0),a.isEnd=!1)},toggle:function(){a.reset();a.sprite.toggle()},play:function(){a.reset();a.sprite.play()},pause:function(){a.reset();a.sprite.pause()},
destroy:function(){c('[data-ref="jquerySprite"]').remove();c(".slide-tmp").remove();l(a.elmt).set("cycle",0);a.reset();a.sprite.destroy();v?(delete f.play,delete f.pause,delete f.toggle,delete f.destroy):(delete f.__proto__.play,delete f.__proto__.pause,delete f.__proto__.toggle,delete f.__proto__.destroy)}};this&&this.hasOwnProperty("play")||(a.main(g),v?(this.play=c.proxy(a.play,a),this.pause=c.proxy(a.pause,a),this.toggle=c.proxy(a.toggle,a),this.destroy=c.proxy(a.destroy,a)):(this.__proto__.play=
c.proxy(a.play,a),this.__proto__.pause=c.proxy(a.pause,a),this.__proto__.toggle=c.proxy(a.toggle,a),this.__proto__.destroy=c.proxy(a.destroy,a)));return f}})(jQuery);
